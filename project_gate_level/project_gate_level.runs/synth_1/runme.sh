...
HD_PWD='C:/EE552_project/project_gate_level/project_gate_level.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sum_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sum_tb.tcl
